...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, depth, depth_weight, depthloss, gt_alpha_mask,
                 image_name, uid,
        ...
        self.original_depthloss = depthloss if depthloss is not None else None

...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    depthloss = cam_info.depthloss if cam_info.depthloss is not None else None
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
                  ...
                  image=gt_image, depth=gt_norm_depth, depth_weight=depth_weight, depthloss = depthloss, gt_alpha_mask=loaded_mask,
